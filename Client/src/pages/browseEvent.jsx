                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span style={{ color: "#F36F21" }}>Date</span>
                        <span>{event.date}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span style={{ color: "#F36F21" }}>Time</span>
                        <span>{event.time}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span style={{ color: "#F36F21" }}>Venue</span>
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-3">
                            <span style={{ color: "#6B7C93" }}>Seats</span>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  },
                  {
                    icon: "Price",
                    label: "Price",
                    value: "Check details after login",
                  },
              ...
              <div className="p-4 rounded-lg" style={{ backgroundColor: "#F5F7FA" }}>
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span style={{ color: "#F36F21" }}>Seats</span>
