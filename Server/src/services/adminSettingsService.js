...
const SETTINGS_SCHEMA = {
  ...
  events: ['defaultCapacity', 'registrationDeadline', 'requireApproval', 'allowWaitlist'],
  email: ['smtpHost', 'smtpPort', 'smtpUser', 'smtpPass'],
  security: ['twoFactorAuth', 'emailVerification', 'passwordComplexity', 'sessionTimeout', 'maxSessions'],
